-- HyperMotion League - Initial Schema (UP)
-- PostgreSQL 15+
...
CREATE TABLE leagues (
    ...
    budget_per_user     INT             NOT NULL DEFAULT 100000000,
...
CREATE TABLE players (
    ...
    market_value    INT             NOT NULL DEFAULT 1000000,
...
CREATE TABLE market_listings (
    ...
    CONSTRAINT uq_market_listing UNIQUE (league_id, player_id, status)
);
